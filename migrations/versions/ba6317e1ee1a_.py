...
Revision ID: ba6317e1ee1a
Revises: c2bcd2d1a498
Create Date: 2021-06-09 22:08:18.577537
...
def upgrade():
    ...
    op.add_column('venues', sa.Column('genres', sa.ARRAY(sa.Text()), nullable=True))
